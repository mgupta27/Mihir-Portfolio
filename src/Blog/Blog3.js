  ...
  return (
    <div className="App">
      ...
      <div className="blog-post">
        ...
        <div className="blog-text">
            The sights were breathtaking to say the least. I've taken so many photos 
            that I've decided to make a blog post showcasing the pictures I took.
        </div>
        ...
        <center>
          <div className="image-5539"></div>
        </center>

        <br />

        <center>
          <div className="image-5540"></div>
        </center>
